...
{
    /// <inheritdoc />
    public partial class AddIdentityAuthen : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Time = table.Column<DateTime>(type: "datetime", nullable: false,defaultValue:"getdate()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServerInfor", x => x.id);
                });
